...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1022.0, 1131.0, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1281.0, 1131.0, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-64::obj-135" : [ "dial[9]", "dial[9]", 0 ],
			"obj-64::obj-145" : [ "number[12]", "number[12]", 0 ],
			"obj-64::obj-146" : [ "button[3]", "button[2]", 0 ],
			"obj-64::obj-148::obj-140" : [ "number[1]", "number[1]", 0 ],
			"obj-64::obj-148::obj-144" : [ "number[2]", "number[2]", 0 ],
			"obj-64::obj-148::obj-145" : [ "number[3]", "number[3]", 0 ],
			"obj-64::obj-15" : [ "slider", "slider", 0 ],
			"obj-64::obj-154" : [ "number[4]", "number[4]", 0 ],
			"obj-64::obj-156" : [ "number[600]", "number[12]", 0 ],
			"obj-64::obj-165" : [ "toggle[39]", "toggle[38]", 0 ],
			"obj-64::obj-166" : [ "kslider", "kslider", 0 ],
			"obj-64::obj-17" : [ "slider[1]", "slider[1]", 0 ],
			"obj-64::obj-171" : [ "toggle[40]", "toggle[37]", 0 ],
			"obj-64::obj-177" : [ "number[7]", "number[6]", 0 ],
			"obj-64::obj-178" : [ "number[601]", "number[10]", 0 ],
			"obj-64::obj-183" : [ "number[599]", "number[10]", 0 ],
			"obj-64::obj-19" : [ "slider[2]", "slider[2]", 0 ],
			"obj-64::obj-20" : [ "toggle", "toggle", 0 ],
			"obj-64::obj-212" : [ "number[602]", "number[10]", 0 ],
			"obj-64::obj-23" : [ "slider[3]", "slider[3]", 0 ],
			"obj-64::obj-255" : [ "dial[13]", "dial[10]", 0 ],
			"obj-64::obj-259" : [ "number[10]", "number[10]", 0 ],
			"obj-64::obj-281" : [ "button[4]", "button[2]", 0 ],
			"obj-64::obj-287" : [ "dial[12]", "dial[10]", 0 ],
			"obj-64::obj-291" : [ "dial[5]", "dial", 0 ],
			"obj-64::obj-294" : [ "toggle[37]", "toggle[37]", 0 ],
			"obj-64::obj-296" : [ "toggle[38]", "toggle[38]", 0 ],
			"obj-64::obj-323" : [ "number[594]", "number[4]", 0 ],
			"obj-64::obj-340::obj-140" : [ "number[595]", "number[1]", 0 ],
			"obj-64::obj-340::obj-144" : [ "number[596]", "number[2]", 0 ],
			"obj-64::obj-340::obj-145" : [ "number[597]", "number[3]", 0 ],
			"obj-64::obj-340::obj-331" : [ "toggle[34]", "toggle[34]", 0 ],
			"obj-64::obj-360" : [ "toggle[41]", "toggle[41]", 0 ],
			"obj-64::obj-37" : [ "toggle[1]", "toggle[1]", 0 ],
			"obj-64::obj-4" : [ "dial[3]", "dial[3]", 0 ],
			...
			"obj-64::obj-505" : [ "dial[7]", "dial", 0 ],
			"obj-64::obj-506" : [ "dial[8]", "dial", 0 ],
			"obj-64::obj-61" : [ "live.gain~", "RETURN key to initialize audio", 0 ],
