...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 94.0, 802.0, 40.0, 22.0 ],
					"text" : "*~ 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 131.0, 802.0, 40.0, 22.0 ],
					"text" : "*~ 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 209.0, 751.0, 92.0, 22.0 ],
					"text" : "onepole~ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 655.0, 39.0, 22.0 ],
					"text" : "$1 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 625.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 553.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 720.0, 358.0, 60.0, 20.0 ],
					"text" : "reverb",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 288.0, 575.0, 40.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 720.0, 380.0, 60.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 224.0, 669.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 209.0, 723.0, 34.0, 22.0 ],
					"text" : "*~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 209.0, 778.0, 68.0, 22.0 ],
					"text" : "cverb~ 500"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 514.0, 94.0, 266.0, 20.0 ],
					"text" : "open sampler, load \"MoshBit_Sampler\" bank",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 324.0, 155.0, 140.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 605.0, 32.0, 140.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.0, 202.5, 244.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 324.0, 120.0, 414.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 331.0, 10.0, 414.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 367.0, 256.0, 251.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 53.0, 62.0, 251.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 324.0, 256.0, 41.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 66.0, 93.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 36.0, 150.0, 20.0 ],
					"text" : "last update 11/8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 34.0, 208.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 680.0, 116.0, 100.0, 20.0 ],
					"text" : "Open Sampler",
					"textoncolor" : [ 0.694117647058824, 0.694117647058824, 0.694117647058824, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 120.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 91.0, 70.0, 22.0 ],
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 151.0, 209.0, 32.0, 22.0 ],
					"text" : "+ 12"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 151.0, 241.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 395.110242486000061, 116.0, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 31.0, 526.0, 50.0, 22.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 99.0, 241.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 31.0, 177.5, 30.0, 22.0 ],
					"text" : "* 12"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 16.0,
					"id" : "obj-18",
					"items" : [ -2, ",", -1, ",", 0, ",", "+1", ",", "+2", ",", "+3", ",", "+4", ",", "+5", ",", "+6", ",", "+7" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 31.0, 120.0, 61.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 241.0, 54.0, 22.0 ],
					"text" : "offset $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 837.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 837.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 31.0, 325.0, 490.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 140.0, 770.0, 216.0 ],
					"range" : 24
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.0, 619.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 31.0, 619.0, 82.0, 22.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 591.0, 29.5, 22.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 94.0, 655.0, 92.5, 22.0 ],
